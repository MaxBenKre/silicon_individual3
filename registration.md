...
- **J.1 Design-space search †** — The same probability-prediction approach was evaluated on 20 Climate Change in the American Mind questions across ten waves from 2020–2024 as part of the broader design process. This secondary entry intentionally preserves the raw T = 1 probability-run output as an ablation: it applies neither calibration nor within-bin heaping. No benchmark outcome data informed this choice.

## K · Reproducibility & frozen artifacts

- **K.1 Code & materials** — https://github.com/dess-mannheim/silicon_sampling_benchmark; relevant files include the probability setup, prompt, configuration, persona manifest, launcher, and result-saving code. This deposit contains predictions/team_6_T1_secondary-2_v1.csv. The source repository records the post-processing seed; DOI: [TBD before submission].
